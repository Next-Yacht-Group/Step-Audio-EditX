...
from spark_runtime import install_compat

# torchaudio's TorchCodec I/O aborts the process on this container and cuDNN
# cannot run the vocoder here — see spark_runtime.
install_compat()
